...
cd /afs/cern.ch/work/f/friti/softtaus/parT/part_training 
...
mv output.tar /afs/cern.ch/work/f/friti/softtaus/parT/part_training/weaver-benchmark/condor/outputs/output_${CLUSTERID}.tar
